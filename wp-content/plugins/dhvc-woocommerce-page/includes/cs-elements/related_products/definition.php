...
class DHVC_Woo_Product_Page_Related_Products extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_related_products', 
			'title' => __( 'WC Single Product Related', DHVC_WOO_PAGE ), 
	...
	public function controls() {
		$this->addControl( 'posts_per_page', 'text', __( 'Product Per Page', DHVC_WOO_PAGE ), '', 4 );
	...
	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_related_products{$extra}]";
