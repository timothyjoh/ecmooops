...
class DHVC_Woo_Product_Page_Best_Selling_Products extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_best_selling_products', 
...
// 						__( 'Price', DHVC_WOO_PAGE ) => 'price' ) ) ) );
	...
	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_best_selling_products{$extra}]";
