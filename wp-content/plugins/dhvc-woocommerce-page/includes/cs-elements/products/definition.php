...
class DHVC_Woo_Product_Page_Products extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_products', 
			'title' => __( 'WC Products', DHVC_WOO_PAGE ), 
	...
	public function controls() {
		$this->addControl( 'ids', 'text', __( 'Add Products IDS', DHVC_WOO_PAGE ), '','');
	...
	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_products{$extra}]";
