	...
	class UserEngageScripts {
		...
		function __construct() {
			add_action( 'admin_init', array(
				&$this,
				'UserEngageScript_admin_init'
			) );
			add_action( 'admin_menu', array(
				&$this,
				'UserEngageScript_admin_menu'
			) );
			add_action( 'wp_head', array(
				&$this,
				'UserEngageScript_wp_head'
			) );
		}
		...
		function UserEngageScript_admin_menu() {
			add_menu_page(
				'UserEngage.com', 'UserEngage.com', 'manage_options', __FILE__, array(
				&$this,
				'UserEngageScript__panel'
                ...
                <div class="ue row two">
                  <div class="ue col">
                    ...
                    <p>Please enter your application key which has been sent to
                      your email address. The api key is a 6 letter and number
