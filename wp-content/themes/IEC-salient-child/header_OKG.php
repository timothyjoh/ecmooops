					...
					<nav id="okg-nav">
						...
						<ul class="sf-menu">	
							...
							//if($has_main_menu == 'true') {
							    wp_nav_menu( array('walker' => new Nectar_Arrow_Walker_Nav_Menu, 'theme_location' => 'okg-menu', 'container' => '', 'items_wrap' => '%3$s' ) ); 
							// } else {
		...
		<ul>
			<?php 
				if($has_main_menu == 'true' && $mobile_fixed == 'false') {
				    ...
				    wp_nav_menu( array('theme_location' => 'okg-menu', 'menu' => 'Top Navigation Menu', 'container' => '', 'items_wrap' => '%3$s' ) ); 
