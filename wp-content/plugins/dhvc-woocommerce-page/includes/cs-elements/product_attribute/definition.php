...
class DHVC_Woo_Product_Page_Product_Attribute extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_product_attribute', 
			'title' => __( 'Woo Product Attribute', DHVC_WOO_PAGE ), 
	...
	public function controls() {
		...
		$this->addControl( 'attribute', 'text', __( 'Attribute', DHVC_WOO_PAGE ), '', '' );
		$this->addControl( 'filter', 'text', __( 'Filter', DHVC_WOO_PAGE ), '', '' );
	}

	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_product_attribute{$extra}]";
