...
class DHVC_Woo_Product_Page_Top_Rated_Products extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_top_rated_products', 
			'title' => __( 'WC Top Rated Products', DHVC_WOO_PAGE ), 
	...
	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_top_rated_products{$extra}]";
