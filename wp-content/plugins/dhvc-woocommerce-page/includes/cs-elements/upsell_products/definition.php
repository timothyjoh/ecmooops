...
class DHVC_Woo_Product_Page_Upsell_Products extends DHVC_Woo_Page_Cornerstone_Element_Base {

	public function data() {
		return array( 
			'name' => 'dhvc_woo_product_page_upsell_products', 
			'title' => __( 'WC Single Product Upsell', DHVC_WOO_PAGE ), 
	...
	public function render( $atts ) {
		extract( $atts );
		$shortcode = "[dhvc_woo_product_page_upsell_products{$extra}]";
